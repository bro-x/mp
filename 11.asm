...
up2:	push rcx
	...
	ret
	;
;sitrc@sitrc-OptiPlex-390:~$ nasm -f elf64 6.mean.asm
;sitrc@sitrc-OptiPlex-390:~$ ld -o 6.mean 6.mean.o
;sitrc@sitrc-OptiPlex-390:~$ ./6.mean

;*** WELCOME TO 64 BIT PROGRAMMING WITH 8087 NDP ***
...
;ARRAY GIVEN IS= 102.56,198.21,100.67,230.78,67.93
