section .data
	...
	menumsg db 10,10,'Menu:'
		...
		db 10,'2) BCD to Hex'
		db 10,'3) Exit'
		db 10,10,'Please Enter Choice :',10
...
;deval@deval-Lenovo-ideapad-300-15ISK:~$/programs$ nasm -f elf64 3.conver.asm
;deval@deval-Lenovo-ideapad-300-15ISK:~$/programs$ ld -o 3.conver 3.conver.o
;deval@deval-Lenovo-ideapad-300-15ISK:~$/programs$ ./3.conver
...
;Enter a 4 digit hex number :000F


;Its BCD Equivalent :15
