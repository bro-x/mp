...
;deval@deval-Lenovo-ideapad-300-15ISK:~/program$ nasm -f elf64 5.gdtr.asm
;deval@deval-Lenovo-ideapad-300-15ISK:~/program$ ld -o 5.gdtr 5.gdtr.o
;deval@deval-Lenovo-ideapad-300-15ISK:~/program$ ./5.gdtr
;Welcome

;Processor is in Protected Mode
;GDT Contents are::2EC4A000:007F
;LDT Contents are::0000
;IDT Contents are::FF576000:0FFF
;deval@deval-Lenovo-ideapad-300-15ISK:~/program$ 
